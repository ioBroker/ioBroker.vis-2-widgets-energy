...
[Consumption](consumption.md) widget does, and adds the buckets up. Point *Energy OID* at the **meter reading**
...
- A period, see [the period](README.md#the-period).
...
| Field                              | Meaning                                                       |
| ---------------------------------- | -------------------------------------------------------------- |
| Widget for time interval selection | The [Interval selector](interval-selector.md) to follow         |
| Start OID / Interval OID           | Period from two data points instead                             |
| Aggregate                          | Only in history mode, see [Consumption](consumption.md)         |
...
4. Follow an [Interval selector](interval-selector.md) and switch it to "month".
...
the [Dynamic electricity price](dynamic-price.md) chart. Note that the costs are then calculated with the price
