...
| Widget for time interval selection | The [Interval selector](interval-selector.md) this chart follows            |
...
4. Place an [Interval selector](interval-selector.md) above it and select it in *Widget for time interval
   selection*.
